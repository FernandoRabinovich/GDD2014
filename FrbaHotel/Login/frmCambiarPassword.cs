...
namespace FrbaHotel
{
    public partial class frmCambiarPassword : Form
    {
        ...
        private bool ValidarCamposRequeridos()
        {
            ...
            if (txtPassAnterior.Text.Length == 0)
                campo = txtPassAnterior.Tag.ToString();
            if (txtPassNueva.Text.Length == 0)
                campo = txtPassNueva.Tag.ToString();
            if (txtPassRepetir.Text.Length == 0)
                campo = txtPassRepetir.Tag.ToString();
